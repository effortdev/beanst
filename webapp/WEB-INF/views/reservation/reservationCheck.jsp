...
<body>
 ...
 %> <%=pageContext.getAttribute("nights")%>박</td>
							...
							<c:choose>
								<c:when
									...
									<button type="button" class="change-btn"
										onclick="location.href='${pageContext.request.contextPath}/reservation/booking.do?mode=update&resId=${reservation.reservationId}'">
										예약 변경</button>
								</c:when>
		...
		<section id="secondSection"
			...
			<div class="no-reservation-message">${userId}고객님의예약정보가없습니다.</div>
		</section>
	...
	<script
		src="${pageContext.request.contextPath}/assets/js/reservation.js"></script>
